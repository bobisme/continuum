...
//! (bn-2npu, Codex cr-3i3rst). A solver adapter therefore cannot hand the checker a structure it
...
pub use receipt::{ClaimKind, Receipt, ReceiptError, Seam, SeamField, receipt};

...
//!
//! This module is the Rust projection of that file: the 74 operations of 19 namespaces
...
//! - [`registry`] — the 74 operations as data, and the protocol's identity constants.
//!

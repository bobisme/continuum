...
//!
//! This module is the Rust projection of that file: the 72 operations of 18 namespaces
...
//! - [`registry`] — the 72 operations as data, and the protocol's identity constants.
//!

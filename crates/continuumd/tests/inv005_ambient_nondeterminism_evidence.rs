...
//! still without a search that would need one: the first four are PR-1/IMPL-01 scaffolds
//! per their own module docs, and `continuum-forge` holds only the task-assembly lane
//! bn-1dsih landed, which enumerates nothing). What is real today is the

...
//! still PR-1/IMPL-01 scaffolds per their own module docs). What is real today is the
//! *prohibition*: `GOV-1-04` already scans those very scaffold crates' `src/` for a

...
mod structural {
    ...
    fn restricting_to_landed_operations_is_a_genuine_narrowing() {
        ...
        assert!(
            all.len() > landed.len(),
            "the unlanded 47 operations declare no free-text fields at all, which would be \
    ...
    fn the_landed_derivation_is_not_vacuous() {
        ...
        // unlanded), the 25-count assertion above would still be a real failure — but this

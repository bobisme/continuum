...
- stale state rejected; (delivered: bn-3r10g — six staleness carriers, each refuses with its declared code leaving a byte-identical effect fingerprint, both TOCTOU directions probed; StaleSnapshot recovery-insufficiency and workspace.diff undetermined tracked bn-27mx7)
